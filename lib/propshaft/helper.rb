...
module Propshaft
  ...
  # - :app - includes only CSS files from the application's app/assets
  #
  ...
  module Helper
    ...
    #   file known to the asset resolver or +:app+ to include css files found in the
    #   application's <tt>app/assets</tt>, which will exclude lib/ and plugins.
    #
    # ==== Options
    #
